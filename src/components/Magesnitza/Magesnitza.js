        ...
        <div className='case-study-magesnitza'>
           <Link className='back-link' to='/'><ion-icon name="arrow-undo-outline"></ion-icon> Back to Home</Link>
            <div className='magesnitza-container'>
                ...
                challenge={'At the time, I still had no idea of ​​back-end and databases. The biggest challenge was learning to query the server and interact with the database.\nWith more reading of the documentation I managed to create a profile page, which I tried to bring as close as possible to the reality in the production phase.'} 
